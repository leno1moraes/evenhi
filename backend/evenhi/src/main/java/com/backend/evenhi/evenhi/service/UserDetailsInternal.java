...
@NoArgsConstructor
@Data
public class UserDetailsInternal implements UserDetails {
    ...
    public UserDetailsInternal(Long id, String username, String email, String password,
    ...
    public static UserDetailsInternal build(User user) {
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || getClass() != o.getClass())
            return false;
        UserDetailsInternal user = (UserDetailsInternal) o;
